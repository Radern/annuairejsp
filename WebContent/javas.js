...
/* echange_window(document1,document2) : Inverser 2 affichage �crans                          */
/* inverse_window(document1) : afficher/cacher une fen�tre                                    */
/* sortTable (tb, n) : pour trier sur une colonne toute une table      */
/* tri(tb, n) : utilis� par sortable                                   */
/**********************************************************************************************/
...
function echange_window(document1,document2)
{
    if (document1.style.display!='block')
    {
        ...
        if (document2!=null) document2.style.display='none';
    }
    else 
